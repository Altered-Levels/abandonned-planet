THREE.GLTFLoader = (function() {
  ...
  GLTFLightsExtension.prototype._markDefs = function() {
    ...
    for (
      var nodeIndex = 0, nodeLength = nodeDefs.length; nodeIndex < nodeLength; nodeIndex++
    ) {
  ...
  GLTFParser.prototype._markDefs = function() {
    ...
    for (
      var skinIndex = 0, skinLength = skinDefs.length; skinIndex < skinLength; skinIndex++
    ) {
    ...
    if (
      ...
      if (materialDef.normalTexture.scale !== undefined) {
        materialParams.normalScale.set(
          materialDef.normalTexture.scale, -materialDef.normalTexture.scale
        );
      }
    }
  ...
  GLTFParser.prototype.loadCamera = function(cameraIndex) {
    ...
    if (cameraDef.type === 'perspective') {
      ...
      camera = new THREE.OrthographicCamera(-params.xmag,
        params.xmag,
