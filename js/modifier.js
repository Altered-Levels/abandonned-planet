      ...
      var o = i(6),
        ...
        s = (function(t) {
          ...
          return (
            ...
            (e.prototype.apply = function() {
              for (
                var t = this.mod.getVertices(), e = 0, i = t; e < i.length; e++
              ) {
                var n = i[e],
                  o = n;
            ...
            (e.prototype.apply = function() {
              for (
                var t = this.mod.getVertices(),
                  ...
                  i = new r.Vector3(
                    0,
                    0, -(this.mod.minZ + this.mod.depth * this.offset)
                  ),
                  n = 0; n < e; n++
              ) {
                var o = t[n],
          ...
          return (
            ...
            (e.prototype.apply = function() {
              ...
              for (t = this._connections.length;
                (e = this._connections[--t]);)
                e.update();
              for (t = this._vertices.length;
                (i = this._vertices[--t]);)
      ...
      var o = i(7),
        ...
        s = (function(t) {
          ...
          return (
            ...
            (e.prototype.apply = function() {
              for (
                var t = this.mod.getVertices(), e = t.length, i = 0; i < e; i++
              ) {
                var n = t[i],
            ...
            (e.prototype.apply = function() {
              ...
              for (
                var t = new r.Vector3(
                  ...
                  i = 0; i < this.mod.getVertices().length; i++
              ) {
